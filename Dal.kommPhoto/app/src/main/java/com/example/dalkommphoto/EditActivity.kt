...
class EditActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ExitActivityButton = findViewById<Button>(R.id.ExitActivityButton)
        val SavePhotoButton = findViewById<Button>(R.id.SavePhotoButton)

        val imageOnEdit = findViewById<ImageView>(R.id.imageOnEdit)


        val cutButton = findViewById<Button>(R.id.cutButton)
        ...
        imageOnEdit.setOnClickListener{
